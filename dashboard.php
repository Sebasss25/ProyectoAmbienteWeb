  ...
  <div class="bg-light py-4">
    <div class="container">
      <div class="row text-center">
        <div class="col-md-3">
          <h3 class="text-success"><?= $totMascotas ?></h3>
          <p class="mb-0">Mascotas rescatadas</p>
        </div>
        <div class="col-md-3">
          <h3 class="text-success"><?= $totAdopciones ?></h3>
          <p class="mb-0">Adopciones exitosas</p>
        </div>
        <div class="col-md-3">
          <h3 class="text-success"><?= $totCampanias ?></h3>
          <p class="mb-0">Campañas activas</p>
        </div>
        <div class="col-md-3">
          <h3 class="text-success"><?= $totVoluntarios ?></h3>
          <p class="mb-0">Voluntarios activos</p>
        </div>
      </div>
    </div>
  </div>
      ...
      <div class="col-md-4 mb-4">
        <div class="card h-100 shadow-sm">
          ...
          <div class="card-body text-center">
            ...
            <a href="eventos_public.php" class="btn btn-success"><i class="fas fa-list"></i> Ver</a>
          </div>
        </div>
      </div>
      <div class="col-md-4 mb-4">
        <div class="card h-100 shadow-sm">
          <div class="card-icon bg-warning text-white text-center py-3"><i class="fas fa-hand-holding-heart fa-3x"></i>
          </div>
          <div class="card-body text-center">
            <h5 class="card-title">Campañas</h5>
            <p class="card-text">¡Echa un vistazo a las campañas activas!</p>
            <a href="campanias_public.php" class="btn btn-success" disabled><i class="fas fa-list"></i> Listado</a>
          </div>
        </div>
      </div>
    </div>
