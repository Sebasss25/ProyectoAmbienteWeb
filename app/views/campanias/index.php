...
<div class="container mt-4">
  ...
  <?php if (!empty($_SESSION['campanias_success'])): ?>
    <div class="alert alert-success"><?= $_SESSION['campanias_success']; unset($_SESSION['campanias_success']); ?></div>
  <?php endif; ?>
  ...
  <div class="table-responsive">
    <table class="table table-striped table-hover">
      ...
      <tbody>
        <?php if ($campanias): foreach ($campanias as $c): ?>
        <tr>
          ...
          <td>
            ...
            <?php if (($_SESSION['rol'] ?? 'usuario') === 'admin'): ?>
              ...
              <a href="campanias.php?action=delete&id=<?= $c['id'] ?>" class="btn btn-danger btn-sm" onclick="return confirm('¿Eliminar campaña?')">
        ...
        <?php endforeach; else: ?>
        <tr><td colspan="7" class="text-center">No hay campañas registradas</td></tr>
        <?php endif; ?>
      </tbody>
    </table>
  </div>
